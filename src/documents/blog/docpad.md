...
* [docpad-plugin-frontend](https://github.com/sergeche/docpad-plugin-frontend) – вывод собранных с помощью `grunt-frontend` CSS и JS с учётом правильного кэширования, а также управление наборами CSS и JS файлов между шаблонами.
